...
from tdvp_utils import make_monitor_dict, randomized_bridge_sample, ess_from_weights
...
class TDVPSchmittRandomizedBridge(TDVPBaseDriver):
    r"""
...
@odefun.dispatch
def odefun_custom(
    state: MCState, self: TDVPSchmittRandomizedBridge, t, w, *, stage=0
):  # noqa: F811
